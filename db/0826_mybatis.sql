...
insert  into `t_department`(`id`,`dept_name`,`pid`,`dept_no`,`creator`,`create_time`,`modifier`,`modify_time`,`state`,`remark`) values (1,'行政部',NULL,'1',0,'2016-07-18 15:30:11',NULL,NULL,'1',NULL),(2,'开发部',NULL,'2',0,'2016-07-18 15:30:19',NULL,NULL,'1',NULL);

/*Table structure for table `t_enum` */
